...
SOPCINFO_FILE := C:/PSE/fourth_pse_actvt/hardware/qsys/SoC1/SoC1.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11080
SOPC_SYSID_FLAG += --sidp=0x11080
ELF_PATCH_FLAG  += --sidp 0x11080

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1730382123
SOPC_SYSID_FLAG += --timestamp=1730382123
ELF_PATCH_FLAG  += --timestamp 1730382123
